...
app.post('/api/register', async (req, res) => {
    ...
    try {
        // تشفير الباسورد (10 ليفل من القوة)
...
app.post('/api/login', async (req, res) => {
    ...
    try {
        // البحث عن الفلاح بالإيميل فقط أولاً
        ...
        if (isMatch) {
            // إنشاء توكن (تذكرة) صالحة لمدة 24 ساعة
...
app.listen(port, () => {
    console.log(`🚀 السيرفر شغال ومؤمن بالكامل على: http://localhost:${port}`);
});